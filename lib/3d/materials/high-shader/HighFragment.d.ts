...
export declare type Vertex = {
    ...
    start?: string;
    /**
     * code will be added during the local transform of the verts
     */
    transform?: string;
    /**
    ...
    main?: string;
    /**
     * code based on calculating lighting goes here
     */
    lighting?: string;
    /**
...
export declare type Fragment = {
    ...
    header?: string;
    /**
     * code here is you want to manipulate the material textures
     */
    material?: string;
    /**
...
//# sourceMappingURL=HighFragment.d.ts.map