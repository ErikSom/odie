...
export declare class Color {
    ...
    fromArray(array: FixedNumberArray<3>, offset?: number): this;
    toArray(array: FixedNumberArray<3>, offset?: number): FixedNumberArray<3>;
    toJSON(): number;
}
